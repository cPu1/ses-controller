...
const (
	FinalizerString = "finalizers.ses.services.k8s.aws/CustomVerificationEmailTemplate"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("customverificationemailtemplates")
	GroupKind            = metav1.GroupKind{
		Group: "ses.services.k8s.aws",
		Kind:  "CustomVerificationEmailTemplate",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CustomVerificationEmailTemplate{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CustomVerificationEmailTemplate),
	}
}
