...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=customverificationemailtemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=customverificationemailtemplates/status,verbs=get;update;patch
