...
const (
	finalizerString = "finalizers.ses.services.k8s.aws/ReceiptRuleSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("receiptrulesets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReceiptRuleSet{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReceiptRuleSet),
	}
}
