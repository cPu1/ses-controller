...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptrulesets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptrulesets/status,verbs=get;update;patch
