...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptrules/status,verbs=get;update;patch
