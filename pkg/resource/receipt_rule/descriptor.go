...
const (
	FinalizerString = "finalizers.ses.services.k8s.aws/ReceiptRule"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("receiptrules")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReceiptRule{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReceiptRule),
	}
}
