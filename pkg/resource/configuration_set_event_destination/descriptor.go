...
const (
	FinalizerString = "finalizers.ses.services.k8s.aws/ConfigurationSetEventDestination"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("configurationseteventdestinations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ConfigurationSetEventDestination{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ConfigurationSetEventDestination),
	}
}
