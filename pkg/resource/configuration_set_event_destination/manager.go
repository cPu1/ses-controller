...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=configurationseteventdestinations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=configurationseteventdestinations/status,verbs=get;update;patch
