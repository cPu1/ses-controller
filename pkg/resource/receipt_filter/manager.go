...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptfilters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=receiptfilters/status,verbs=get;update;patch
