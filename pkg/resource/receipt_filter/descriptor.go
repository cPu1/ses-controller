...
const (
	FinalizerString = "finalizers.ses.services.k8s.aws/ReceiptFilter"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("receiptfilters")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReceiptFilter{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReceiptFilter),
	}
}
