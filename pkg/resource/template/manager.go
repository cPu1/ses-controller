...
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=templates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.services.k8s.aws,resources=templates/status,verbs=get;update;patch
