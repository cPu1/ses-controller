...
const (
	FinalizerString = "finalizers.ses.services.k8s.aws/Template"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("templates")
