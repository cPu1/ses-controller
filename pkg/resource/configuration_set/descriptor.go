...
const (
	finalizerString = "finalizers.ses.services.k8s.aws/ConfigurationSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("configurationsets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ConfigurationSet{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ConfigurationSet),
	}
}
